...
- `Actions` for _LiveStream_ and _Videos_ within `InteractionMetadata`:
...
[TODO: Still missing a complete Asset Interfaces Description example. If there is no intention to add one, simply delete this TODO]
